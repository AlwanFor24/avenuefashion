...
<i class="fa fa-dashboard"></i> Dashboard /Ubah Kebijakan
</li>
...
<label class="col-md-3 control-label"> Kebijakan </label>
...
<label class="col-md-3 control-label"> Poin-poin Penting <!--berupa link--> </label>
