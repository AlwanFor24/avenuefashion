...
<i class="fa fa-dashboard"></i> Dashboard / Tambah Brand
...
<i class="fa fa-money fa-fw"> </i> Tambah Brand
...
<label class="col-md-3 control-label"> Nama Brand </label>
...
<label class="col-md-3 control-label"> Sebagai Brand Teratas </label>
...
<label class="col-md-3 control-label"> Gambar Brand </label>
