...
<i class="fa fa-dashboard"> </i> Dashboard / Tambah Produk
...
<label class="col-md-3 control-label" > Pilih Brand </label>
...
<label class="col-md-3 control-label" > Harga Spesial </label>
...
<a data-toggle="tab" href="#features"> Saran Pencucian </a>
