...
// Gantilah penggunaan $ip_add dengan ID sesi
$user_id = session_id();
$insert_cart = "INSERT INTO cart (p_id, ip_add, qty, size, p_price) VALUES (?, ?, ?, ?, ?)";
$stmt_insert = mysqli_prepare($con, $insert_cart);
mysqli_stmt_bind_param($stmt_insert, "issis", $pro_id, $user_id, $pro_qty, $pro_size, $only_price);
//mysqli_stmt_execute($stmt_insert);
// Gantilah $ip_add dengan $user_id saat mengambil produk dari keranjang belanja
$select_cart = "SELECT * FROM cart WHERE ip_add=?";
$stmt_select = mysqli_prepare($con, $select_cart);
mysqli_stmt_bind_param($stmt_select, "s", $user_id);
mysqli_stmt_execute($stmt_select);
$run_cart = mysqli_stmt_get_result($stmt_select);
session_destroy();
?>
