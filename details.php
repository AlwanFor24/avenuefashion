  ...
  <main>
    ...
    <div class="nero">
      <div class="nero__heading">
        <span class="nero__bold">DETAIL </span>PRODUK
      </div>
      <p class="nero__text">
      </p>
    </div>
...
<option>Tambah ke keranjang</option>
<!--<option>1</option>
<option>2</option>
<option>3</option>
<option>4</option>
...
<i class="fa fa-heart" ></i> Tambah ke Favorit Saya
...
<h3 class="text-center">Kamu mungkin juga suka </h3>
...
$product_price = "<del> Rp.$pro_price,00 </del>";

$product_psp_price = "| Rp.$pro_psp_price,00";
...
<a href='$pro_url' class='btn btn-default' >Detail Produk</a>
