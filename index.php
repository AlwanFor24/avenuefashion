    ...
    <footer class="page-footer">
        ...
        <div class="container clearfix">
          ...
          <div class="footer-nav__col footer-nav__col--info">
            ...
            <ul class="footer-nav__list">
              ...
              <li class="footer-nav__item">
                <a href="#" class="footer-nav__link">Lokasi Toko</a>
              </li>
              <li class="footer-nav__item">
          ...
          <div class="footer-nav__col footer-nav__col--contacts">
            <div class="footer-nav__heading">KONTAK HUBUNG</div>
            ...
            <div class="phone">
              Telephone:
              <a class="phone__number" href="tel:0123456789">1227050017</a>
            </div>
            <div class="email">
              Email:
              <a href="mailto:support@yourwebsite.com" class="email__addr">1227050017</a>
            </div>
          </div>
      ...
      <div class="page-footer__subline">
        <div class="container clearfix">
          ...
          <div class="copyright">
            &copy; <?php echo date("Y");?>UIN SGD BANDUNG&trade;
          </div>

          <div class="developer">
            by Alwan Maulana Firdaus
          </div>
