...
<a id='payment-link'href="order.php?c_id="<?php echo $customer_id; ?>>Bayar</a>
<!--<button > <a href="order.php?c_id=<?php echo $customer_id; ?>" > Bayar </a></button>-->
<script>
// For example trigger on button clicked, or any time you need
//var payButton = document.getElementById('payment-link');
